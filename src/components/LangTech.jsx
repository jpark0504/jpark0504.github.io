...
const LangTech = () => {
    ...
    return (
        <div name='langtech' className='bg-gradient-to-b from-black to-gray-800 w-full h-screen'>
            <div className='max-w-screen-lg p-4 pa-8 mx-auto flex flex-col justify-center w-full h-full text-white'>
                <div>
